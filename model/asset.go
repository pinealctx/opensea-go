...
type Asset struct {
	...
	BackgroundColor interface{} `opensea:"background_color" json:"backgroundColor"`
	...
	AnimationURL         interface{} `opensea:"animation_url" json:"animationURL"`
	AnimationOriginalURL interface{} `opensea:"animation_original_url" json:"animationOriginalURL"`
	// Name of the item
	Name        string      `opensea:"name" json:"name"`
	Description interface{} `opensea:"description" json:"description"`
	// External link to the original website for the item
	ExternalLink interface{} `opensea:"external_link" json:"externalLink"`
	...
	SellOrders interface{} `opensea:"sell_orders" json:"sellOrders"`
	...
	ListingDate             interface{}     `opensea:"listing_date" json:"listingDate"`
	...
	RelatedAssets           []interface{}   `opensea:"related_assets" json:"relatedAssets"`
...
type LastSale struct {
	...
	AssetBundle    interface{}   `opensea:"asset_bundle" json:"assetBundle"`
	EventType      string        `opensea:"event_type" json:"eventType"`
	EventTimestamp string        `opensea:"event_timestamp" json:"eventTimestamp"`
	AuctionType    interface{}   `opensea:"auction_type" json:"auctionType"`
